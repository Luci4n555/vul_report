...
class Order extends Api
{
    ...
    public function getRules()
    {
        return array(
            ...
            'orderSaveCartApi' => array(
                ...
                'order_amount' => array('name' => 'order_amount', 'require' => false, 'min' => 0, 'desc' => '商品结算价格'),
                ...
                'sku' => array('name' => 'sku', 'require' => false, 'min' => 0, 'max' => 255, 'desc' => '货品列表'),
                'msg' => array("name" => "msg", "require" => false, "min" => 0, "max" => 255, "desc" => "订单留言"),
                'platform' => array("name" => "platform", "require" => false, "min" => 0, "max" => 255, "desc" => "订单来源"),
            ),
    ...
    public function orderDetailListApi()
    {
        ...
        $get_can = $cart_model->get_can_invoice();
        ...
        $cart_goods['total']['can_invoice'] = $get_can['can_invoice'];
        $cart_goods['total']['use_integral'] = $get_can['use_integral'];
        $cart_goods['total']['use_bonus'] = $get_can['use_bonus'];
    ...
    public function orderSaveCartApi()
    {
        ...
        $order_id = $this->model->gen_order($user_id, $address_id, $shipping_id, $bonus_id, $point, $tax_data, $pack_name, $pack_fee, $ral, $integralGoodsid, $o_time, $super, $superGoodsid, $delivery_id, $delivery_name, $result_spike, $goods_id, $p_type, $pintuan, $pintuanGoodsId, $pintuanNumber, $productId, $pintuanOrderId, $order_amount, $msg,$sku,$platform);
        if (!$order_id) {
    ...
    public function orderlistActionApi()
    {
        ...
        if ($status == '1') {
            $data['order_list'] = $data['order_list'];
        } else {
