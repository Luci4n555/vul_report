    ...
    public function getRules()
    {
        return array(
            ...
            "nextBingdingMobile" => array(
                ...
                "platform" => array("name" => "platform", "require" => false, "min" => 1, "desc" => "平台类型"),
                "unionid" => array("name" => "unionid", "require" => false, "min" => 0, "desc" => 'unionid'),
                'nickname' => array('name' => 'nickname', 'require' => true, 'min' => 1, 'max' => 50, 'desc' => '用户名'),
            ),
            ...
            "getWxAuthApi" => array(
                "url" => array("name" => 'url', "require" => false, "desc" => "跳转连接"),
            ),
            ...
            "cancellation" => array(
                'user_id' => array('name' => 'user_id', 'require' => true, 'min' => 1, 'max' => 50, 'desc' => '用户ID'),
                'user_name' => array('name' => 'user_name', 'require' => false, 'desc' => '用户昵称'),
            ),
            "cancellationSta" => array(
                'user_id' => array('name' => 'user_id', 'require' => true, 'min' => 1, 'max' => 50, 'desc' => '用户ID'),
            ),
        );
    }
...
//            return array('is_login' => false, 'user_id' => '');
    ...
    public function nextBingdingMobile()
    {
        ...
        $data['user_id'] = $this->model->nextBingdingMobileModel($openid, $platform, $unionid, $nickname);
...
//         var_dump($data);die;
    ...
    public function cancellation()
    {
        ...
        return $this->Userlib->appcancellation($user_id,$user_name);
    }
     ...
     * @throws \PhalApi\Exception
     */
    public function cancellationSta()
    {
        $user_id = $this->user_id;

        return $this->Userlib->appcancellation_sta($user_id);
    }
