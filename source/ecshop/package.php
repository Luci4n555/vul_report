...
{
    //-生鲜 $row['start_time']  = local_date('Y-m-d H:i', $row['start_time']);
    //-生鲜 $row['end_time']    = local_date('Y-m-d H:i', $row['end_time']);
    $row['start_time']  = local_date('M d, Y H:i:s', $row['start_time']);//-生鲜
