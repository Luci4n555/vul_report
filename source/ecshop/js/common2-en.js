...
//生成层内内容
html = '<div class="conclose"><span>Successfully added！</span></div><div class="cartpopDiv"><div class="toptitle"><a href="goods.php?id='+goods_id+'" class="pic"><img src='+pic+' width="100" height="100"/></a><p><span>'+name+'</span><font class="word_c1">'+price+'</font></p><div class="clear0"></div></div>';
html += '<div class="coninfo">';
html +='Total<strong class="word_c1">'+number+'</strong>goods,subtotals:<strong  class="word_c">'+total+'</strong>';
html +='</div>';

html +="<div class='fd30_btn'><a href=\'javascript:cancel_div()\' class='a_word_c'>See more</a><a href='flow.php?step=checkout' class='bg_c fd_submit' >To settle</a></div>";
html +='</div></div>';
