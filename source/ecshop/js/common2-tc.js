...
html +='購物車共有<strong class="word_c1">'+number+'</strong>種商品，合計：<strong  class="word_c">'+total+'</strong>';
html +='</div>';

html +="<div class='fd30_btn'><a href=\'javascript:cancel_div()\' class='a_word_c'>再逛逛</a><a href='flow.php?step=checkout' class='bg_c fd_submit' >去結算</a></div>";
html +='</div></div>';
