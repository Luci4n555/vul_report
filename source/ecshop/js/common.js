...
function repurchase(order_id) {
  //var cart_url = 'flow.php?step=cart&type=5';//跳转购物车，只显示再次购买内容
  var cart_url = 'flow.php?step=cart';//考虑已经预先加入购物车的商品
...
function addPackageToCart(packageId)
{
  ...
  var str = JSON.stringify(package_info);

  Ajax.call('flow.php?step=add_package_to_cart', 'package_info=' + str, addPackageToCartResponse, 'POST', 'JSON');
