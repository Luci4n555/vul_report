...
define('OS_PINTUAN',                7); // 拼团订单
define('OS_MIAOSHA',                8); // 秒杀订单
...
define('VERSION_UTF8', 'https://update.shopex.com.cn/version/program/ECShop/ecshop_patch_list.txt');
...
// 生成二维码
define('QRCODE_URL', 'https://wenhairu.com/static/api/qr/?size=100&text=');
// 生成短链接
