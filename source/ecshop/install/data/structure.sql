...
CREATE TABLE `ecs_admin_action` (
  ...
  `action_code` varchar(22) NOT NULL DEFAULT '',
...
CREATE TABLE `ecs_ad_position` (
  `position_id` smallint(3) UNSIGNED NOT NULL,
...
--
-- 表的结构 `ecs_cancellation`
--

DROP TABLE IF EXISTS `ecs_cancellation`;
CREATE TABLE `ecs_cancellation` (
  `id` int(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` int(8) NOT NULL COMMENT '用户ID',
  `user_name` varchar(255) DEFAULT NULL COMMENT '用户名',
  `status` varchar(255) NOT NULL DEFAULT '0' COMMENT '注销状态',
  `add_time` varchar(60) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
...
--
-- 表的结构 `ecs_cancellation_log`
--

DROP TABLE IF EXISTS `ecs_cancellation_log`;
CREATE TABLE `ecs_cancellation_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `admin_name` varchar(60) DEFAULT NULL COMMENT '管理员名称',
  `user_name` varchar(60) DEFAULT NULL COMMENT '会员名称',
  `status` varchar(255) DEFAULT NULL COMMENT '操作状态',
  `add_time` varchar(60) DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ecs_users` (
  ...
  `nickname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信小程序名称'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
--
ALTER TABLE `ecs_ad_position`
  MODIFY `position_id` smallint(3) UNSIGNED NOT NULL AUTO_INCREMENT;
