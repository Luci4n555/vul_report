...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2005-2023 <a href="https://www.ecshop.com" target="_blank">商派软件有限公司</a>，保留所有权利。';
...
$_LANG['js_languages']['db_exists'] = '当前数据库已经存在数据，确定要覆盖该数据库吗？';
