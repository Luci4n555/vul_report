...
$_LANG['flow_login_register']['email_not_null'] = '請您輸入郵箱！';
$_LANG['flow_login_register']['email_invalid'] = '您輸入的郵箱不正確！';
...
$_LANG['login_success'] = '恭喜！您已經成功登錄本站！';
...
$_LANG['stock_insufficiency'] = '對不起，您選擇的商品 %s 的庫存數量只有 %d，您最多只能購買 %d 件。';
$_LANG['package_stock_insufficiency'] = '對不起，您選擇的超值禮包數量已經超出庫存。請您減少購買量或聯繫商家。';
$_LANG['shopping_flow'] = '購物流程';
$_LANG['username_exists'] = '您輸入的用戶名已存在，請更換！';
$_LANG['email_exists'] = '您輸入的郵箱已存在，請更換！';
$_LANG['surplus_not_enough'] = '您使用的餘額不能超過當前餘額！';
$_LANG['integral_not_enough'] = '您使用的積分不能超過當前積分！';
$_LANG['integral_too_much'] = "您使用的積分不能超過%d";
$_LANG['invalid_bonus'] = "您選擇的紅包不存在！";
...
$_LANG['flow_no_shipping'] = '您必須選擇一個配送方式！';
$_LANG['flow_no_payment'] = '您必須選擇一個支付方式！';
$_LANG['pay_not_exist'] = '選擇的支付方式不存在！';
...
$_LANG['no'] = '無';
$_LANG['not_support_virtual_goods'] = '購物車中存在非實體商品,不支持匿名購買,請登錄後再購買';
...
$_LANG['flow_js']['invalid_email'] = '您輸入的郵箱格式不正確！';
...
$_LANG['not_fount_consignee'] = '對不起，您選擇的收貨地址不存在！';
