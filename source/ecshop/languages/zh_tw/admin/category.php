...
$_LANG['cat_top'] = '頂級分類';
$_LANG['show_in_nav'] = '移動端分類頁顯示';
$_LANG['show_in_nav_h5'] = '移動端首頁頂部顯示';
$_LANG['show_in_nav_pc'] = '是否顯示在pc巡覽列';
...
$_LANG['cate_img'] = '分類圖片';
$_LANG['show_in_h5_desc'] = '(開啟後會在移動端首頁上部顯示分類圖片，只顯示設定的前10個分類； 如果分類圖片不上傳則不顯示，但會佔據前10個名額)';
$_LANG['picture_url'] = '分類遠程圖片連結位址';
$_LANG['nav'] = '導航欄';
$_LANG['index_new'] = '最新';
$_LANG['index_best'] = '精品';
$_LANG['index_hot'] = '熱門';
...
$_LANG["cat_isleaf"] = '不是末級分類或者此分類下還有商品,您不能刪除!';
$_LANG["cat_noleaf"] = '該分類下還有其它子分類,不能修改為末級分類!';
...
$_LANG['cat_move_notic'] = '在添加商品或者在商品管理中,如果需要對商品的分類進行變更,那麼您可以通過此功能管理商品分類。';

$_LANG['cat_move_empty'] = '您沒有正確選擇商品分類!';

$_LANG['sel_goods_type'] = '請選擇商品類型';
$_LANG['sel_filter_attr'] = '請選擇篩選屬性';
$_LANG['filter_attr'] = '篩選屬性';
$_LANG['filter_attr_notic'] = '篩選屬性可在PC端分類頁面快速篩選商品';
