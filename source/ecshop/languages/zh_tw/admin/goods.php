...
$_LANG['batch_trash_confirm'] = '您確定要把選中的商品放入回收站嗎？';
$_LANG['trash_product_confirm'] = '您確定要把該商品刪除嗎？';
$_LANG['restore_goods_confirm'] = '您確定要把該商品還原嗎？';
$_LANG['batch_restore_confirm'] = '您確定要把選中的商品還原嗎？';
$_LANG['batch_on_sale_confirm'] = '您確定要把選中的商品上架嗎？';
$_LANG['batch_not_on_sale_confirm'] = '您確定要把選中的商品下架嗎？';
$_LANG['batch_best_confirm'] = '您確定要把選中的商品設為精品嗎？';
$_LANG['batch_not_best_confirm'] = '您確定要把選中的商品取消精品嗎？';
$_LANG['batch_new_confirm'] = '您確定要把選中的商品設為新品嗎？';
$_LANG['batch_not_new_confirm'] = '您確定要把選中的商品取消新品嗎？';
$_LANG['batch_hot_confirm'] = '您確定要把選中的商品設為熱銷嗎？';
$_LANG['batch_not_hot_confirm'] = '您確定要把選中的商品取消熱銷嗎？';
...
$_LANG['lab_suppliers'] = '供應商';
$_LANG['copy'] = '複製';
$_LANG['item_list'] = '貨品列表';
$_LANG['if_on_sale'] = '上架狀態';
$_LANG['integral'] = '積分額度';
$_LANG['on_sale'] = '上架';
...
$_LANG['goods_sn_exists'] = '您輸入的貨號已存在，請更換！';
...
$_LANG['lab_is_free_shipping'] = '是否包郵：';
...
$_LANG['group_price']         = '拼團價';
$_LANG['spike_price']         = '開啟秒殺';
$_LANG['spike_goods_number']         = '商品數量';
$_LANG['spike_goods_amount']         = '商品金額';
$_LANG['spike_goods_num_des']         = '請輸入秒殺商品的數量';
$_LANG['spike_goods_amo_des']         = '請輸入秒殺商品的金額';
...
$_LANG['js_languages']['batch_no_on_sale'] = '您確定要將選定的商品下架嗎？';
$_LANG['js_languages']['batch_trash_confirm'] = '您確定要把選中的商品放入回收站嗎？';
$_LANG['js_languages']['go_category_page'] = '本頁數據將丟失，確定要去商品分類頁添加分類嗎？';
$_LANG['js_languages']['go_brand_page'] = '本頁數據將丟失，確定要去商品品牌頁添加品牌嗎？';
...
$_LANG['goods_sn_exists'] = '您输入的货号已存在，请更換！';
?>