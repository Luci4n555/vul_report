...
$_LANG['js_languages']['email_empty'] = '郵箱不能為空!';
$_LANG['js_languages']['email_error'] = '郵箱格式不正確!';
...
$_LANG['edit_password_succeed'] = '您已經成功的修改了密碼，請重新登錄!';
$_LANG['user_name_exist'] = '該管理員已經存在!';
$_LANG['email_exist'] = '郵箱已經存在!';
$_LANG['captcha_error'] = '您輸入的驗證碼不正確！';
$_LANG['login_faild'] = '您輸入的帳號信息不正確！';
$_LANG['user_name_drop'] = '刪除成功!';
...
$_LANG['remove_cannot'] = '您不能对此管理員進行刪除操作!';
...
$_LANG['email_notic'] = '請輸入管理員的l郵箱';
$_LANG['confirm_notic'] = '請輸入管理員的密碼,兩次輸入必須一致';

/* 登錄表單 */
$_LANG['label_username'] = '管理員姓名：';
$_LANG['label_password'] = '管理員密碼：';
$_LANG['label_captcha'] = '驗證碼：';
$_LANG['click_for_another'] = '看不清？點擊更換';
