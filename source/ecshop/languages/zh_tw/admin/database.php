...
$_LANG['mysql_version_error'] = '當前mysql版本%s與備份數據的mysql版本%s不同，您確認要導入該備份文件嗎?';
$_LANG['confirm_ver'] = '是，確認導入';
$_LANG['unconfirm_ver'] = '否，取消導入';
$_LANG['version_error'] = 'ECShop 當前版本%s與備份數據版本%s不同，備份恢復失敗';
$_LANG['not_sql_file'] = '您上傳的好像不是sql文件，如果文件確實是sql文件，請將文件擴展名改為.sql';
$_LANG['sqlfile_error'] = '您上傳的sql文件執行出錯，備份恢復失敗';
...
/* js */
$_LANG['js_languages']['remove_confirm'] = '您確定要刪除該備份嗎？';
...
$_LANG['confirm_remove'] = '您確定要刪除選中數據嗎？';
