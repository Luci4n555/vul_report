...
$_LANG['todolist'] = '記事本';
$_LANG['n_a'] = 'N/A';
$_LANG['picture_add_error'] = '圖片地址錯誤！';
$_LANG['picture_format'] = '圖片格式只能為jpg,jpeg,png,pjpeg,x-png,gif';
$_LANG['up_picture'] = '請上傳圖片！';
$_LANG['fillin_word'] = '請填寫文字！';
$_LANG['edit_succed'] = '修改成功!';
$_LANG['dele_succed'] = '删除成功!';
$_LANG['fillin_all_sub'] = '請全部填寫後提交！';
...
$_LANG['user_hitCounts'] = '商品瀏覽統計';

/* 促銷管理 */
$_LANG['02_snatch_list'] = '奪寶奇兵';
$_LANG['snatch_add'] = '添加奪寶奇兵';
$_LANG['04_bonustype_list'] = '紅包管理';
...
$_LANG['11_user_cancellation'] = 'APP帳號註銷申請';
$_LANG['12_user_cancellation_log'] = 'APP帳號註銷日誌';
...
$_LANG['07_sms_send_vcode'] = '驗證碼記錄';

$_LANG['affiliate'] = '推薦設置';
$_LANG['affiliate_ck'] = '分成管理';
$_LANG['user_recommend'] = "分成用戶";
...
$_LANG['end_time'] = '移動端截單設定';
$_LANG['prompt_image'] = '首頁彈窗設定';
$_LANG['kefu'] = '移動端客服電話';
$_LANG['download'] = 'APP下載地址設定';
$_LANG['logo_setting'] = '首頁Logo設定';
$_LANG['login_image'] = '登録頁Logo設定';
$_LANG['keywords'] = '熱門搜索設定';
$_LANG['pay_dispose'] = '移動端支付設定';
$_LANG['logistics'] = '物流査詢設定';
$_LANG['index_imgae'] = '首頁廣告設定';
$_LANG['default_image'] = '商品默認圖片';
$_LANG['copyright_modify'] = '移動端版權設定';
$_LANG['live_settings'] = '小程式直播設定';
$_LANG['privacy_rights'] = '小程式隱私協定';
$_LANG['apple_login'] = '蘋果APP登録';
$_LANG['my_subordinates'] = '我的下級開關';
$_LANG['set_my_subordinates'] = '在移動端開啟“我的下級”';

$_LANG['stop_order_time'] = '截止時間';
$_LANG['stop_order_dese'] = '截止說明';
$_LANG['open_or_not'] = '是否開啟';

$_LANG['kefu_position'] = '顯示位置：我的-聯系客服';

$_LANG['coupon_id'] = '紅包ID';
$_LANG['coupon_by_user'] = '按用戶發送類型';
$_LANG['picture_url'] = '圖片地址';
$_LANG['link_empty'] = '請填寫鏈接地址';

/* APP帳號註銷*/
$_LANG['appl_username'] = '用戶名';
$_LANG['appl_number'] = '編號';
$_LANG['appl_status'] = '狀態';
$_LANG['appl_time'] = '註銷申請時間';
$_LANG['appl_freezing'] = '冷凍期';
$_LANG['status_passed'] = '已通過';
$_LANG['status_cancelled'] = '已撤銷';
$_LANG['appl_allow'] = '通過';
$_LANG['appl_cancel'] = '撤銷';
$_LANG['appl_allow_confirm'] = '你確認要通過嗎?';
$_LANG['appl_cancel_confirm'] = '你確認要撤銷嗎?';
$_LANG['admin_name'] = '管理員';
$_LANG['operate_record'] = '操作記錄';
$_LANG['operate_date'] = '操作日期';
$_LANG['record_passed'] = '已通過帳號註銷申請';
$_LANG['record_cancelled'] = '已撤銷帳號註銷申請';
$_LANG['record_delete'] = '删除數據';
$_LANG['record_self_release'] = '用戶自行解除註銷申請';


/* 物流査詢設定*/
$_LANG['kdn_company'] = 'kdniao.com';
$_LANG['kdn_useid'] = '用戶ID';
$_LANG['kdn_logist_company'] = '物流公司編碼';
$_LANG['kdn_submit'] = '提交';

/* 移動端支付設定*/
$_LANG['wechat_applet_pay'] = '微信小程式支付配寘';
$_LANG['wechat_applet_id'] = 'AppID（小程式ID）';
$_LANG['wechat_applet_sec'] = 'AppSecret（小程式金鑰）';
$_LANG['wechat_applet_merc'] = '小程式綁定的微信支付商戶號';
$_LANG['wechat_merc_api'] = '微信支付商戶號API v2金鑰';
$_LANG['call_verifi_add'] = '回檔驗證地址';
$_LANG['call_recei_add'] = '回檔接收地址';

$_LANG['h5_pay']= 'H5微信支付配寘';
$_LANG['h5_domain'] = 'PC網址';
$_LANG['h5_off_accid'] = 'H5綁定的公眾號開發者ID（AppId）';
$_LANG['h5_off_cipher'] = '公眾號開發者密碼（AppSecret）';
$_LANG['h5_off_merc'] = '公眾號綁定的微信支付商戶號';
$_LANG['submit'] = '提交';

$_LANG['wechat_app_pay'] = 'APP微信支付配寘';
$_LANG['wechat_open_id'] = '微信開放平臺的移動應用AppID';
$_LANG['wechat_open_sec'] = '開放平臺的移動應用AppSecret';
$_LANG['wechat_app_merc'] = 'APP綁定的微信支付商戶號';

$_LANG['alipay_pay'] = '支付寶支付配寘';
$_LANG['alipay_h5_domain'] = 'H5支付地址';
$_LANG['alipay_gateway'] = '支付寶閘道地址';
$_LANG['alipay_id'] = '支付寶應用APPID';
$_LANG['alipay_pri_key'] = '開發助手創建的應用私密金鑰';
$_LANG['alipay_pub_key'] = '開放平臺生成的支付寶公開金鑰';
$_LANG['alipay_h5_url'] = 'H5地址';
/* 移動端-版權設定*/
$_LANG['copyright_first'] = '第一行';
$_LANG['copyright_second'] = '第二行';
/* 移動端-logo設定*/
$_LANG['logo_image_other'] = '登録頁、注册頁、修改密碼頁logo设置';
$_LANG['logo_image_desc'] = 'http://或者https://開始';
$_LANG['logo_image_home'] = '首頁Logo設定';
/* 移動端-小程式直播設定*/
$_LANG['live_image'] = '入口展示圖';
$_LANG['live_applet'] = '僅小程式生效';
$_LANG['live_info_get'] = '獲取app_ key與app_ secret請前往';
$_LANG['live_info_sp'] = '商派雲服務平臺';
/* 移動端--熱門搜索*/
$_LANG['hot_search'] = '熱門關鍵字搜索';
$_LANG['hot_keyword'] = '關鍵字';
$_LANG['hot_key_desc'] = '排序值大的顯示在前-移動端只展示最前面的三個';
$_LANG['fillin_key'] = '請填寫熱門關鍵字';
$_LANG['key_sort_desc'] = '該項數值越大位置越靠前';
/* 移動端--廣告*/
$_LANG['ad_word'] = '顯示文字';
$_LANG['caro_h5_url'] = 'H5端跳轉連結';
$_LANG['caro_app_url'] = 'APP端跳轉連結';
$_LANG['caro_applet_url'] = '小程式端跳轉連結';
$_LANG['caro_url_desc'] = '也可以填寫商品ID，下同';
/* 移動端---小程式隱私協定*/
$_LANG['wechat_app_pol'] = '用戶政策';
/* 移動端-蘋果app登入*/
$_LANG['apple_login_set'] = '是否開啟蘋果APP的Apple ID登録';
$_LANG['apple_login_desc'] = '僅用於App提交App Store稽核時使用，稽核通過後請關閉。';
/* 移动端-App更新和下載*/
$_LANG['app_down_name'] = 'App名稱';
$_LANG['app_cur_ver'] = 'App當前版本';
$_LANG['app_lat_ver'] = 'App最新版本';
$_LANG['app_ios_url'] = 'iOS App更新地址';
$_LANG['app_and_url'] = '安卓App更新地址';
/* 短信设置*/
$_LANG['sms_phone'] = '手機號碼';
$_LANG['sms_very_code'] = '驗證碼';
$_LANG['sms_send_time'] = '發送時間';
$_LANG['sys_active_lic_desc'] = '删除證書後，將會影響簡訊、授權、綁定等功能，請謹慎操作！';
$_LANG['sys_active_crm_desc'] = '實現全通路各類型客戶的精准運營及長期經營.';
$_LANG['sys_active_crm_detail'] = '點擊瞭解詳情';
$_LANG['sys_active'] = '';
$_LANG['sys_active_desc'] = '用商派帳號啟動您的系統，享受手機短信等更多應用和服務';
$_LANG['sys_active_accou'] = '沒有商派帳號嗎？';
$_LANG['sys_active_reg_desc'] = '點擊下方按鈕一步完成注册啟動！';
$_LANG['sys_active_regist'] = '免費註冊商派帳號';
$_LANG['sys_active_have_acc'] = '我有商派帳號';
$_LANG['sys_active_sp_desc'] = '品牌企業零售數位化服務商';
$_LANG['sys_active_sp_skip'] = '跳過授權';
$_LANG['sys_active_sp_name'] = '商派';
