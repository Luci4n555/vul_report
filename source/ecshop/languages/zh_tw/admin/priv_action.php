...
$_LANG['lead_manage'] = '移動端';
$_LANG['certificate_manage'] = '雲服務中心';
...
$_LANG['user_cancel'] = 'APP帳戶註銷';
$_LANG['user_cancel_log'] = 'APP帳戶註銷日誌';
//權限管理部分的權限
...
$_LANG['sms_sign'] = '簡訊簽名';
$_LANG['sms_send_vcode']='驗證碼記錄';
$_LANG['sms_set_vcode']='簡訊設定';
...
$_LANG['banner_mobile'] = '移動端輪播圖設定';
//$_LANG['lead'] = '店铺二维码';
//$_LANG['mobile_setting'] = 'APP应用配置';
//$_LANG['h5_setting'] = 'H5应用配置';
//$_LANG['wxa_setting'] = '小程序应用配置';
//$_LANG['leancloud'] = 'APP推送管理';
$_LANG['logistics'] = '物流査詢配寘';
$_LANG['keywords'] = '熱門搜索關鍵字管理';
$_LANG['pay_dispose'] = '支付配寘';
$_LANG['end_time']='APP截單設定';
?>