...
$_LANG['notice_gb_ship'] = '備註：團購活動未處理為成功狀態前，不能發貨';
...
$_LANG['no_print_shipping'] = '對不起,目前您還沒有設置打印快遞單模板.不能進行打印';
...
$_LANG['js_languages']['confirm_drop'] = '確定要刪除該商品嗎？';
