...
$_LANG['note_attr_type'] = '選擇「單選/復選屬性」時，可以對商品該屬性設置多個值，同時還能對不同屬性值指定不同的價格加價，消費者購買商品時需要選定具體的屬性值。選擇「唯一屬性」時，商品的該屬性值只能設置一個值，用戶只能查看該值。';
...
/* 提示信息 */
$_LANG['name_exist'] = '該屬性名稱已存在，請更換！';
$_LANG['drop_confirm'] = '確定要刪除該屬性嗎？';
$_LANG['notice_drop_confirm'] = '已經有%s個商品使用該屬性，您確定要刪除該屬性嗎？';
$_LANG['name_not_null'] = '屬性名稱不能為空！';

$_LANG['no_select_arrt'] = '您沒有選擇需要刪除的屬性名';
$_LANG['drop_ok'] = '成功刪除了 %d 條商品屬性';

$_LANG['js_languages']['name_not_null'] = '屬性名稱不能為空！';
