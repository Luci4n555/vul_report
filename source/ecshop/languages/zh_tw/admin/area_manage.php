...
$_LANG['add_country'] = '添加一級地區';
$_LANG['add_province'] = '添加二級地區';
$_LANG['add_city'] = '添加三級地區';
$_LANG['add_cantonal'] = '添加四級地區';

/* JS語言項 */
$_LANG['js_languages']['region_name_empty'] = '地區名稱不能為空!';
$_LANG['js_languages']['option_name_empty'] = '調查選項名稱不能為空!';
...
$_LANG['area_drop_confirm'] = '如果訂單或用戶默認配送方式中使用以下地區，這些地區信息將顯示爲空。您確定要刪除這條記錄嗎?';
