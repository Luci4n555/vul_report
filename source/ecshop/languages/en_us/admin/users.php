...
$_LANG['label_rank_name'] = 'Member level';
$_LANG['all_option'] = 'All...';

$_LANG['view_order'] = 'Order details';
$_LANG['view_deposit'] = 'Account details';
$_LANG['username'] = 'Username';
$_LANG['email'] = 'Email';
$_LANG['is_validated'] = 'Verified';
...
$_LANG['recode'] = 'Invitation code';
$_LANG['superior'] = 'Superior member';
$_LANG['rank_points'] = 'Member level points';
$_LANG['user_money'] = 'Available money';
$_LANG['frozen_money'] = 'Frozen money';
$_LANG['credit_line'] = 'Credit line';
$_LANG['user_rank'] = 'Member level';
$_LANG['not_special_rank'] = 'Non special';
...
$_LANG['notice_pay_points'] = 'Consumption points are an internal currency that allows users to pay a certain percentage of points for deduction when shopping.';
$_LANG['notice_rank_points'] = 'Member level points are cumulative points that the system uses to determine a user\'s membership level.';
...
$_LANG['js_languages']['invalid_rank_points'] = 'The points of member level must be an integer.';
