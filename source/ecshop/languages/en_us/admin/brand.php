...
$_LANG['brand_logo_notes'] = 'Picture link address';
...
$_LANG['is_show_home'] = 'Show on home page';
$_LANG['is_show_notes'] = 'After opening, it will be displayed on the home page of the mobile phone, and only the first four settings will be displayed';
