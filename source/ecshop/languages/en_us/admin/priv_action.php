...
$_LANG['sms_manage'] = 'Mobile SMS';
$_LANG['lead_manage'] = 'Mobile terminal';
$_LANG['certificate_manage'] = 'Cloud Service';
...
$_LANG['suppliers_goods'] = 'Management of suppliers of goods';
$_LANG['user_hitCounts']='Commodity browsing statistics';
...
$_LANG['user_rank'] = 'Member level management';
...
$_LANG['user_cancel'] = 'APP account cancellation application';
$_LANG['user_cancel_log'] = 'APP account cancellation log';
...
$_LANG['user_recommend']='Shared users';
...
$_LANG['bonus_manage'] = 'Coupon management';
...
$_LANG['sms_sign'] = 'SMS signature';
$_LANG['sms_send_vcode']='Verification code record';
$_LANG['sms_set_vcode']='SMS settings';
...
$_LANG['banner_mobile'] = 'Carousel picture';
//$_LANG['lead'] = '店铺二维码';
//$_LANG['mobile_setting'] = 'APP应用配置';
//$_LANG['h5_setting'] = 'H5应用配置';
//$_LANG['wxa_setting'] = '小程序应用配置';
//$_LANG['leancloud'] = 'APP推送管理';
$_LANG['logistics'] = 'Logistics Query';
$_LANG['keywords'] = 'Hot Search';
$_LANG['pay_dispose'] = 'Payment';
$_LANG['end_time']='Stop Order Setting';
