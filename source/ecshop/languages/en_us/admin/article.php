...
$_LANG['special_recommend'] = 'Special recommendation';
$_LANG['mobile_display'] = 'Display on mobile terminal';
$_LANG['mobile_display_desc'] = 'After opening, it will be displayed on the mobile terminal. When setting multiple, only the first five will be displayed';
$_LANG['background_image'] = 'Background image';
$_LANG['is_set'] = 'Yes';
$_LANG['no_set'] = 'No';
