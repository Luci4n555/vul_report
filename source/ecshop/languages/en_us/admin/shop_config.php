...
$_LANG['cfg_name']['goods'] = 'Goods display';
...
$_LANG['cfg_name']['image_width'] = 'Goods image width';
$_LANG['cfg_name']['image_height'] = 'Goods image height';
$_LANG['cfg_name']['best_number'] = 'Competitive goods quantity';
$_LANG['cfg_name']['new_number'] = 'New goods quantity';
$_LANG['cfg_name']['hot_number'] = 'Active stock quantity';
$_LANG['cfg_name']['promote_number'] = 'Promotion goods quantity';
...
$_LANG['cfg_name']['bought_goods'] = 'Relative goods quantity';
...
$_LANG['cfg_name']['sn_prefix'] = 'Goods\'s NO. prefixion';
...
$_LANG['cfg_name']['no_picture'] = 'Default image of goods';
...
$_LANG['cfg_name']['goods_name_length'] = 'Goods name length';
$_LANG['cfg_name']['price_format'] = 'Goods price display regulation';
...
$_LANG['cfg_name']['attr_related_number'] = 'Goods quantity of relational attribute';
...
$_LANG['cfg_desc']['market_price_rate'] = 'While you enter goods price, the system will calculate market price by proportion automatically.';
...
$_LANG['cfg_desc']['comments_number'] = 'Display customer reviews quantity at goods details page.';
...
$_LANG['cfg_desc']['bought_goods'] = 'How many records are displayed, that customers who bought this item also bought goods?';
$_LANG['cfg_desc']['currency_format'] = 'Display goods price format, the %s will be replaced corresponding price figure.';
...
$_LANG['cfg_desc']['attr_related_number'] = 'How many relational goods are displaied in the goods details page.';
...
$_LANG['cfg_range']['sort_order_type']['1'] = 'By goods price';
...
$_LANG['cfg_range']['timezone']['-12'] = '(UTC -12:00) International Date Line West';
$_LANG['cfg_range']['timezone']['-11'] = '(UTC -11:00) Samoa,Niue';
$_LANG['cfg_range']['timezone']['-10'] = '(UTC -10:00) Hawaii';
$_LANG['cfg_range']['timezone']['-9'] = '(UTC -09:00) Alaska';
$_LANG['cfg_range']['timezone']['-8'] = '(UTC -08:00) Pacific Time (US and Canada),Los Angeles,San Francisco,Vancouver,Seattle,Las Vegas';
$_LANG['cfg_range']['timezone']['-7'] = '(UTC -07:00) Mountain Time (USA and Canada),Arizona,Mazatlán,Phoenix,Salt Lake City,Denver,Edmonton';
$_LANG['cfg_range']['timezone']['-6'] = '(UTC -06:00) Central Time (US and Canada),Mexico City,Monterrey,Chicago,Houston,New Orleans,Memphis';
$_LANG['cfg_range']['timezone']['-5'] = '(UTC -05:00) Eastern Time (United States and Canada),Colombia,Toronto,Ecuador,Peru,Cuba,New York,Hamilton';
$_LANG['cfg_range']['timezone']['-4.5'] = '(UTC -04:30) Venezuela';
$_LANG['cfg_range']['timezone']['-4'] = '(UTC -04:00) Bolivia,Paraguay,Chile';
$_LANG['cfg_range']['timezone']['-3.5'] = '(UTC -03:30) Newfoundland';
$_LANG['cfg_range']['timezone']['-3'] = '(UTC -03:00) Brazil,Uruguay,Argentina,Suriname';
$_LANG['cfg_range']['timezone']['-2'] = '(UTC -02:00) South Georgia and the South Sandwich Islands,Fernando de Noronha';
$_LANG['cfg_range']['timezone']['-1'] = '(UTC -01:00) Cape Verde,Azores';
$_LANG['cfg_range']['timezone']['0'] = '(UTC +00:00) Coordinated Universal Time,Portugal,Britain,Ireland,Casablanca';
$_LANG['cfg_range']['timezone']['1'] = '(UTC +01:00) Central Europe,West Africa,Western Central Africa,France,Netherlands,Italy,Spain,Serbia,Belgium,Tunisia,Morocco';
$_LANG['cfg_range']['timezone']['2'] = '(UTC +02:00) Eastern Europe,Central Africa,Eastern Türkiye,Israel,South Africa,Egypt,Greece,Syria';
$_LANG['cfg_range']['timezone']['3'] = '(UTC +03:00) East Africa,Russia,Iraq,Kuwait,Saudi Arabia,Istanbul';
$_LANG['cfg_range']['timezone']['3.5'] = '(UTC +03:30) Iran';
$_LANG['cfg_range']['timezone']['4'] = '(UTC +04:00) UAE,Georgia,Mauritius,Oman';
$_LANG['cfg_range']['timezone']['4.5'] = '(UTC +04:30) Afghanistan';
$_LANG['cfg_range']['timezone']['5'] = '(UTC +05:00) Pakistan,Turkmenistan,Maldives';
$_LANG['cfg_range']['timezone']['5.5'] = '(UTC +05:30) India';
$_LANG['cfg_range']['timezone']['5.75'] = '(UTC +05:45) Nepal';
$_LANG['cfg_range']['timezone']['6'] = '(UTC +06:00) Novosibirsk,Kyrgyzstan,Bangladesh,Bhutan';
$_LANG['cfg_range']['timezone']['6.5'] = '(UTC +06:30) Myanmar';
$_LANG['cfg_range']['timezone']['7'] = '(UTC +07:00) Thailand,Vietnam,Indonesia';
$_LANG['cfg_range']['timezone']['8'] = '(UTC +08:00) China,Malaysia,Philippines,Singapore,Mongolia,Hong Kong of China,Macau of China,Taiwan of China';
$_LANG['cfg_range']['timezone']['9'] = '(UTC +09:00) Japan,South Korea,North Korea,East Timor';
$_LANG['cfg_range']['timezone']['9.5'] = '(UTC +09:30) Adelaide,Darwin';
$_LANG['cfg_range']['timezone']['10'] = '(UTC +10:00) Australia,Vladivostok,Guam';
$_LANG['cfg_range']['timezone']['11'] = '(UTC +11:00) Magadan,New Caledonia,Sakhalin,Solomon Islands';
$_LANG['cfg_range']['timezone']['12'] = '(UTC +12:00) New Zealand,Fiji,Nauru';
$_LANG['cfg_range']['timezone']['13'] = '(UTC +13:00) Tonga';
...
$_LANG['cfg_name']['recommend_order'] = 'Recommended goods sort';
