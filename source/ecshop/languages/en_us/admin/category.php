...
$_LANG['cat_top'] = 'Root';
$_LANG['show_in_nav'] = 'Smartphone category page';
$_LANG['show_in_nav_h5'] = 'Displayed on the smartphone homepage';
$_LANG['cat_style'] = 'Style sheet document classification';
$_LANG['is_show'] = 'Display or not';
...
$_LANG['cate_img'] = 'Category Picture';
$_LANG['show_in_h5_desc'] = '(When enabled, it will be displayed on the smartphone home page, but only the first 10 settings will be displayed; If the classified image is not uploaded, the classification will not be displayed, but will occupy the top 10 positions)';
$_LANG['picture_url'] = 'Picture link address';
