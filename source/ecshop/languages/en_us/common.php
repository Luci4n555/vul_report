...
$_LANG['goods_bonus'] = 'Get a coupon:';
...
$_LANG['comment_brought'] = 'No login or never bought the product you would like to comment';
...
$_LANG['with_price'] = 'and face value';
$_LANG['de'] = '';
$_LANG['bonus'] = 'coupon';
$_LANG['goods_all_price'] = 'Total amount of goods';
$_LANG['discount'] = 'discount';
$_LANG['tax'] = 'tax';
$_LANG['shipping_fee'] = 'Shipping expenses';
$_LANG['pack_fee'] = 'Packing expenses';
$_LANG['card_fee'] = 'Greeting card expenses';
$_LANG['total_fee'] = 'Total amount payable';
...
/* 倒计时 */
$_LANG['goods_js']['day'] = ' DD ';
$_LANG['goods_js']['hour'] = ' HH  ';
$_LANG['goods_js']['minute'] = ' MM ';
$_LANG['goods_js']['second'] = ' SS';
...
$_LANG['gbs_under_way'] = 'From deadline:';
...
$_LANG['au_under_way'] = 'From deadline:';
...
$_LANG['creating_failure'] = 'Failed to create image!';
$_LANG['writting_failure'] = 'Failed to write image!';
$_LANG['empty_watermark'] = 'The parameter of watermark is empty!';
$_LANG['missing_watermark'] = 'Can not find %s';
$_LANG['create_watermark_res'] = 'Failed to create resource of watermark! The image type is %s';
$_LANG['create_origin_image_res'] = 'Failed to create resource of origin image! The image type is %s';
...
$_LANG['p_y']['link_start'] = '<a href="https://www.shopex.cn/products/ecshop?from=nav" target="_blank" style=" font-family:Verdana; font-size:11px;">';
...
$_LANG['order_query_toofast'] = 'The frequency of order query is too high!';
...
$_LANG['fee_total'] = 'Total expenses';
...
$_LANG['operation'] = 'Operate';
$_LANG['download_file'] = 'Download';

/* 模板首页 */
$_LANG['my_orders'] = 'My orders';
$_LANG['add_favorite'] = 'Add to favorite';
$_LANG['scan_wechat'] = 'Mobile';
$_LANG['recom_brand'] = 'Recommended brands';
$_LANG['mall_announ'] = 'Announcement';
$_LANG['specials_goods'] = 'Specials';
$_LANG['more_goods'] = 'More';
$_LANG['more_cat'] = 'Category';
$_LANG['is_account'] = 'Not registered?';
$_LANG['forgot_pass'] = 'Forgot password';
$_LANG['member_login'] = 'Log in';
$_LANG['pwd_lower'] = 'Wak';
$_LANG['pwd_middle'] = 'Medium';
$_LANG['pwd_high'] = 'Strong';
$_LANG['sms_captcha'] = 'SMS code';
$_LANG['agree_register'] = 'Agree and register';
$_LANG['top_cart_info'] = 'Cart';
$_LANG['top_cart_items'] = 'pieces';
$_LANG['cart_goods_num'] = 'Total';
$_LANG['cart_goods_amount'] = 'goods,subtotals:';
$_LANG['cart_goods_conti'] = 'Checkout';
$_LANG['cart_no_goods'] = 'Go shopping!';
$_LANG['vip_price'] = 'Vip price';
$_LANG['recent_sales'] = 'Recent sales';
$_LANG['buy_bund_goods'] = 'Buy bundled';
$_LANG['goods_detail'] = 'Details';
$_LANG['conti_shopping'] = 'Continue shopping';
$_LANG['get_captcha'] = 'Get';
$_LANG['place_order'] = 'Place order';
$_LANG['share_goods'] = 'Share';
$_LANG['member_center'] = 'User Center';
$_LANG['account_center'] = 'Account Center';
$_LANG['service_center'] = 'Service Center';
$_LANG['order_center'] = 'Order Center';
$_LANG['shelf_time'] = 'Shelf time';
$_LANG['update_time'] = 'Update time';
$_LANG['goods_promo'] = 'Reduce';
$_LANG['goods_price'] = 'Price';
$_LANG['goods_rating'] = 'Ratings';
$_LANG['goods_details'] = 'Details';
$_LANG['goods_reviews'] = 'user comments';
$_LANG['goods_points'] = 'Points';
$_LANG['goods_points_num'] = 'items';
$_LANG['goods_points_hot'] = 'Hot commodities';
$_LANG['goods_best_seller'] = 'Best-seller ';
$_LANG['group_buy_alr'] = '';
$_LANG['group_buy_number'] = 'people have bought it';
$_LANG['group_buy_buy'] = 'Buy';
$_LANG['group_buy_join'] = 'Join';
$_LANG['group_buy_closed'] = 'Closed';
$_LANG['group_buy_desc'] = 'Limited group purchase';
$_LANG['group_buy_notes'] = 'Purchase Notes';
$_LANG['group_buy_time'] = 'To';
$_LANG['group_buy_reach'] = 'Reaches';
$_LANG['back_to_top'] = 'Top';
$_LANG['page_to_page'] = 'Go to';
/* 生鲜模板 */
$_LANG['sx_goods_comp'] = 'Comprehensive';
$_LANG['sx_goods_popu'] = 'Popularity';
$_LANG['sx_goods_disc'] = 'Discount';
$_LANG['sx_goods_best'] = 'Best';
$_LANG['sx_goods_new'] = 'New';
$_LANG['sx_goods_hot'] = 'Hot';
$_LANG['sx_goods_sale'] = 'Finish';
$_LANG['sx_goods_order'] = 'deals';
$_LANG['sx_goods_inter'] = 'Interest';
$_LANG['sx_point_refer'] = 'Reference price:';
$_LANG['sx_goods_guess'] = 'Guess it\'s what you like';
$_LANG['sx_on_service'] = 'Online Service';
$_LANG['sx_add_consig'] = 'Add new consignee';
$_LANG['sx_consig_rema'] = 'Remarks';
$_LANG['sx_serv_time'] = 'Service Time';
$_LANG['sx_serv_tele'] = 'Customer Service';
$_LANG['sx_end_time'] = 'To the end of this session,only have';
$_LANG['sx_group_still'] = 'Still';
$_LANG['sx_group_mun'] = 'pieces';
$_LANG['user_register_desc'] = 'Enter user name or phone number';
$_LANG['get_pass_sms'] = 'Get the password by SMS';
$_LANG['get_pass_phone'] = 'Phone number';
$_LANG['reset_pass'] = 'Reset password';
$_LANG['reset_pass_new'] = 'New password';
$_LANG['sx_goods_com_num'] = 'person times';
$_LANG['sx_topic_title'] = 'Limited time purchase today';
$_LANG['sx_empty_cart'] = 'Empty cart';
$_LANG['sx_batch_dele_cart'] = 'Batch Delete';
$_LANG['sx_pay_charge'] = 'Service Charge';
$_LANG['sx_pay_free'] = 'Free';
$_LANG['sx_defa_pack'] = 'Default packaging';
$_LANG['sx_order_reach'] = 'Reach';
$_LANG['sx_order_deli'] = 'No delivery card required';
$_LANG['sx_order_invoi'] = 'Invoice or not';
$_LANG['sx_invoi_conte'] = 'Please enter invoicing content...';
$_LANG['sx_help_cent'] = 'Help Center';
$_LANG['sx_pack_logis'] = 'Package logistics status';
$_LANG['sx_acco_recha'] = 'Recharge';
$_LANG['sx_memb_avat'] = 'Avatar';
$_LANG['sys_active'] = 'You need to activate the system';
$_LANG['sys_active_desc'] = 'Activate your system with a ShopeX account and enjoy more applications and services such as SMS';
$_LANG['sys_active_accou'] = 'No ShopeX account?';
$_LANG['sys_active_reg_desc'] = 'Click the button below to complete registration in one step!';
$_LANG['sys_active_regist'] = 'Free registration of ShopeX account';
$_LANG['sys_active_have_acc'] = 'I have a ShopeX account';
$_LANG['sys_active_sp_desc'] = 'Service provider for brand enterprise retail digitization';
$_LANG['sys_active_sp_skip'] = 'Skip authorization';
$_LANG['sys_active_sp_name'] = 'ShopeX';

$_LANG['sms_veri_err'] = 'SMS verification code error';
$_LANG['sms_veri_expir'] = 'The SMS verification code has expired';
$_LANG['message_pdf'] = 'The uploaded PDF file has potential risks, please edit and upload again!';
$_LANG['message_pdf_xss'] = 'Content has risks!';