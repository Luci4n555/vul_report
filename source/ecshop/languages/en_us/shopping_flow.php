...
$_LANG['direct_shopping'] = 'Buy directly without login';
$_LANG['goods_not_exists'] = 'Sorry, the product is nonexistence.';
$_LANG['drop_goods_confirm'] = 'Are you sure you want to remove it from the cart?';
...
$_LANG['invalid_bonus'] = "The coupon you selected does not exist!";
$_LANG['no_goods_in_cart'] = 'Your shopping cart is empty!';
...
$_LANG['flow_no_shipping'] = 'Please select shipping method!';
$_LANG['flow_no_payment'] = 'Please select payment method!';
$_LANG['pay_not_exist'] = 'The payment method does not exist!';
...
$_LANG['shipping_address'] = 'Ship to this address';
$_LANG['address_amount'] = 'The place of receipt should be less than three';
$_LANG['not_fount_consignee'] = 'Sorry, the shipping address does not exist';
...
$_LANG['remember_order_number'] = 'Thanks for your shopping! Your order has been submitted successfully. Your order number is';
...
$_LANG['validate_bonus'] = 'Vadidate coupon';
$_LANG['input_bonus_no'] = 'Input coupon No.';
$_LANG['select_bonus'] = 'Select existing coupon';
$_LANG['bonus_sn_error'] = 'Please enter valid coupon No.';
$_LANG['bonus_min_amount_error'] = 'Order amount is less than the minimum amount of coupon %s';
$_LANG['bonus_is_ok'] = 'Coupon No. is avaible, can be used as %s';
