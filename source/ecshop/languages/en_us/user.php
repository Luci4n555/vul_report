...
//JS语言项
$_LANG['profile_js']['bonus_sn_empty'] = 'Please enter a coupon NO. that you want to add!';
$_LANG['profile_js']['bonus_sn_error'] = 'Please enter a valid coupon NO.!';
...
/* 会员红包 */
$_LANG['bonus_is_used'] = 'The coupon has used.';
$_LANG['bonus_is_used_by_other'] = 'The coupon has used by others.';
$_LANG['bonus_add_success'] = 'Add a new coupons successfully.';
$_LANG['bonus_not_exist'] = 'The coupon is nonexistent.';
$_LANG['user_bonus_empty'] = 'You have no coupon now';
$_LANG['add_bonus_sucess'] = 'Successfully added a new coupon!';
$_LANG['add_bonus_false'] = 'Failed to add a new coupon!';
$_LANG['bonus_add_expire'] = 'Coupon expired!';
$_LANG['bonus_use_expire'] = 'Coupon expired!';
...
$_LANG['merge'] = 'Merge';
$_LANG['notice_order_sn'] = 'The combined information of the order form(such as payment method, shipping method packaging,card,coupon etc) will be correct information, if there are some distinction between two order forms.';
...
$_LANG['get_password_by_question'] = 'Find the password through the question';
$_LANG['get_password_by_mail'] = 'Find the password through Email';
...
$_LANG['agreement'] = "I agree to《<a href=\"article.php?cat_id=-1\" style=\"color:blue\">User agreement</a>》";
...
　　3.  Within links <b>%d%s</b> clicked by visitors，if visitors register in our shop, they are recognized as your recommendation and you can get member leve points <b>%d</b> as an award (no more award when your member leve points are over <b>%d</b> ).
...
$_LANG['level_point_all'] = 'Percentage of points commission in total points';
$_LANG['level_money_all'] = 'Percentage of commission amount in total amount';
$_LANG['level_register_all'] = 'Member level points obtained after registration';
$_LANG['level_register_up'] = 'Total number of member level points obtained';
...
$_LANG['level_point'] = 'Percentage of points commission';
$_LANG['level_money'] = 'Percentage of commission amount';
...
$_LANG['affiliate_lever'] = 'Recommender level';
...
$_LANG['to_rank_points'] = 'Congratulations! %s BBS %s transform into %s member level points';
...
$_LANG['rank_points'] = 'Member level point ';
