...
$_LANG['flow_login_register']['email_not_null'] = '请您输入邮箱！';
$_LANG['flow_login_register']['email_invalid'] = '您输入的邮箱不正确！';
...
$_LANG['drop_goods_confirm'] = '您确定要把该商品移出购物车吗？';
$_LANG['goods_number_not_int'] = '请您输入正确的商品数量！';
$_LANG['stock_insufficiency'] = '对不起，您选择的商品 %s 的库存数量只有 %d，您最多只能购买 %d 件。';
$_LANG['package_stock_insufficiency'] = '对不起，您选择的超值礼包数量已经超出库存，请您减少购买量或联系商家。';
$_LANG['shopping_flow'] = '购物流程';
$_LANG['username_exists'] = '您输入的用户名已存在，请更换！';
$_LANG['email_exists'] = '您输入的邮箱已存在，请更换！';
$_LANG['surplus_not_enough'] = '您使用的余额不能超过当前余额！';
$_LANG['integral_not_enough'] = '您使用的积分不能超过当前积分！';
$_LANG['integral_too_much'] = "您使用的积分不能超过%d";
$_LANG['invalid_bonus'] = "您选择的红包不存在！";
...
$_LANG['pay_invalid'] = '您选用了一个无效的支付方式，该支付方式不存在或者已经被停用，请您立即和我们联系。';
$_LANG['flow_no_shipping'] = '您必须选择一个配送方式！';
$_LANG['flow_no_payment'] = '您必须选择一个支付方式！';
$_LANG['pay_not_exist'] = '选择的支付方式不存在！';
...
$_LANG['no'] = '无';
$_LANG['not_support_virtual_goods'] = '购物车中存在非实体商品,不支持匿名购买,请登录后再购买';
...
$_LANG['flow_js']['invalid_email'] = '您输入的邮箱格式不正确！';
...
$_LANG['not_fount_consignee'] = '对不起，您选择的收货地址不存在！';
