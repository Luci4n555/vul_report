...
$_LANG['is_show_home'] = '是否首页显示';
$_LANG['is_show_notes'] = '开启后会在手机端进行展示，开启多个则只展示开启的前4个';
