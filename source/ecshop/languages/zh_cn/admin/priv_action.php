...
$_LANG['user_cancel'] = 'APP账户注销';
$_LANG['user_cancel_log'] = 'APP账户注销日志';
...
//$_LANG['time_list']='移动端配送时间';
//$_LANG['delivery_method']='移动端配送方式';
//促销管理
...
$_LANG['sms_sign'] = '短信签名';
$_LANG['sms_send_vcode']='验证码记录';
$_LANG['sms_set_vcode']='短信设置';
//云服务中心管理
...
$_LANG['logistics'] = '物流查询配置';
$_LANG['keywords'] = '热门搜索设置';
$_LANG['pay_dispose'] = '支付配置';
$_LANG['end_time']='APP截单设置';