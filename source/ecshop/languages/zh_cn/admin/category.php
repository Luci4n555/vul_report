...
$_LANG['cat_top'] = '顶级分类';
$_LANG['show_in_nav'] = '移动端分类页显示';
$_LANG['show_in_nav_h5'] = '移动端首页顶部显示';
$_LANG['show_in_nav_pc'] = '是否显示在pc导航栏';
...
$_LANG['cate_img'] = '分类图片';
$_LANG['show_in_h5_desc'] = '(开启后会在移动端首页上部显示分类图片，只显示设置的前10个分类；如果分类图片不上传则不显示，但会占据前10个名额)';
$_LANG['picture_url'] = '分类远程图片链接地址';
$_LANG['nav'] = '导航栏';
$_LANG['index_new'] = '最新';
$_LANG['index_best'] = '精品';
$_LANG['index_hot'] = '热门';
...
$_LANG['cat_move_notic'] = '在添加商品或者在商品管理中,如果需要对商品的分类进行变更,那么您可以通过此功能管理商品分类。';

$_LANG['cat_move_empty'] = '您没有正确选择商品分类!';

$_LANG['sel_goods_type'] = '请选择商品类型';
$_LANG['sel_filter_attr'] = '请选择筛选属性';
$_LANG['filter_attr'] = '筛选属性';
$_LANG['filter_attr_notic'] = '筛选属性可在PC端分类页面快速筛选商品';
