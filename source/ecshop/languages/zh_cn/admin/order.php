...
$_LANG['cs'][OS_PINTUAN] = '拼团商品';
$_LANG['cs'][OS_MIAOSHA] = '秒杀商品';
...
$_LANG['notice_gb_ship'] = '备注：团购活动未处理为成功状态前，不能发货';
...
$_LANG['no_print_shipping'] = '对不起,目前您还没有设置打印快递单模板.不能进行打印';
...
$_LANG['js_languages']['confirm_drop'] = '确定要删除该商品吗？';
