...
$_LANG['note_attr_type'] = '选择"单选/复选属性"时，可以对商品该属性设置多个值，同时还能对不同属性值指定不同的价格加价，消费者购买商品时需要选定具体的属性值。选择"唯一属性"时，商品的该属性值只能设置一个值，消费者只能查看该值。';
...
/* 提示信息 */
$_LANG['name_exist'] = '该属性名称已存在，请更换！';
$_LANG['drop_confirm'] = '确定要删除该属性吗？';
$_LANG['notice_drop_confirm'] = '已经有%s个商品使用该属性，您确定要删除该属性吗？';
$_LANG['name_not_null'] = '属性名称不能为空！';

$_LANG['no_select_arrt'] = '您没有选择需要删除的属性名';
$_LANG['drop_ok'] = '成功删除了 %d 条商品属性';

$_LANG['js_languages']['name_not_null'] = '属性名称不能为空！';
$_LANG['js_languages']['values_not_null'] = '请输入该属性的可选值';
$_LANG['js_languages']['cat_id_not_null'] = '请选择该属性所属的商品类型';
