...
$_LANG['js_languages']['email_empty'] = '邮箱不能为空!';
...
$_LANG['edit_password_succeed'] = '您已经成功的修改了密码，请重新登录!';
$_LANG['user_name_exist'] = '该管理员已经存在!';
$_LANG['email_exist'] = '邮箱已经存在!';
$_LANG['captcha_error'] = '您输入的验证码不正确！';
$_LANG['login_faild'] = '您输入的帐号信息不正确！';
$_LANG['user_name_drop'] = '删除成功!';
$_LANG['pwd_error'] = '输入的旧密码错误!';
$_LANG['old_password_empty'] = '如果要修改密码,必须先输入您的旧密码!';
...
$_LANG['remove_cannot'] = '您不能对此管理员进行删除操作!';
...
$_LANG['email_notic'] = '请输入管理员的邮箱';
$_LANG['confirm_notic'] = '请输入管理员的密码,两次输入必须一致';

/* 登录表单 */
$_LANG['label_username'] = '管理员姓名：';
$_LANG['label_password'] = '管理员密码：';
$_LANG['label_captcha'] = '验证码：';
$_LANG['click_for_another'] = '看不清？点击更换';
