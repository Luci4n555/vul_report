...
$_LANG['posit_name_exist'] = '此广告位已存在!';
$_LANG['posit_desc_length'] = '描述不能有特殊字符，最大20位';
...
$_LANG['js_languages']['width_value'] = '广告位的宽度值必须在1到10240之间!';
$_LANG['js_languages']['height_value'] = '广告位的高度值必须在1到10240之间!';
$_LANG['width_number'] = '广告位的宽度必须是一个数字!';
$_LANG['height_number'] = '广告位的高度必须是一个数字!';
$_LANG['width_value'] = '广告位的宽度值必须在1到10240之间!';
$_LANG['not_del_adposit'] = '该广告位已经有广告存在,不能删除!';

/* 帮助语言项 */
$_LANG['position_name_notic'] = '填写广告位置的名称，如：页脚广告，LOGO广告，右侧广告,通栏二_左边部分等等';
$_LANG['ad_width_notic'] = '广告位置的宽度,广告显示时的宽度,单位为像素';
...
$_LANG['ad_code_repeat'] = '广告图片只能是上传的图片文件或者是指定的网络图片';
$_LANG['ad_flash_repeat'] = 'Flash广告只能是上传的Flash文件或者是指定远程的Flash文件';
$_LANG['ad_name_exist'] = '该广告名称已经存在!';
$_LANG['ad_name_notic'] = '广告名称只是作为管理多个广告条目之用，并不显示在广告中';
$_LANG['ad_code_img'] = '图片尺寸请参考广告位尺寸；或者填写网络图片的URL地址进行调用';
