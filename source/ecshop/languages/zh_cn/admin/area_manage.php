...
$_LANG['add_country'] = '添加一级地区';
$_LANG['add_province'] = '添加二级地区';
$_LANG['add_city'] = '添加三级地区';
$_LANG['add_cantonal'] = '添加四级地区';

/* JS语言项 */
$_LANG['js_languages']['region_name_empty'] = '地区名称不能为空!';
$_LANG['js_languages']['option_name_empty'] = '调查选项名称不能为空!';
$_LANG['js_languages']['drop_confirm'] = '确定要删除这条记录吗?';
