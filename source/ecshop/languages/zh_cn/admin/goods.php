...
$_LANG['continue_add_goods'] = '继续添加商品';
$_LANG['back_goods_list'] = '返回商品列表';
$_LANG['add_goods_ok'] = '添加商品成功！';
$_LANG['edit_goods_ok'] = '编辑商品成功！';
$_LANG['trash_goods_ok'] = '商品放入回收站成功！';
$_LANG['restore_goods_ok'] = '还原商品成功！';
$_LANG['drop_goods_ok'] = '删除商品成功！';
$_LANG['batch_handle_ok'] = '批量操作成功！';
$_LANG['drop_goods_confirm'] = '您确定要删除该商品吗？';
$_LANG['batch_drop_confirm'] = '彻底删除商品将删除与该商品有关的所有信息。\n确定要删除选中的商品吗？';
$_LANG['trash_goods_confirm'] = '您确定要把该商品放入回收站吗？';
$_LANG['trash_product_confirm'] = '您确定要把该货品删除吗？';
$_LANG['batch_trash_confirm'] = '您确定要把选中的商品放入回收站吗？';
$_LANG['restore_goods_confirm'] = '您确定要把该商品还原吗？';
$_LANG['batch_restore_confirm'] = '您确定要把选中的商品还原吗？';
$_LANG['batch_on_sale_confirm'] = '您确定要把选中的商品上架吗？';
$_LANG['batch_not_on_sale_confirm'] = '您确定要把选中的商品下架吗？';
$_LANG['batch_best_confirm'] = '您确定要把选中的商品设为精品吗？';
$_LANG['batch_not_best_confirm'] = '您确定要把选中的商品取消精品吗？';
$_LANG['batch_new_confirm'] = '您确定要把选中的商品设为新品吗？';
$_LANG['batch_not_new_confirm'] = '您确定要把选中的商品取消新品吗？';
$_LANG['batch_hot_confirm'] = '您确定要把选中的商品设为热销吗？';
$_LANG['batch_not_hot_confirm'] = '您确定要把选中的商品取消热销吗？';
...
$_LANG['add_good'] = '添加新商品';
$_LANG['goods_name'] = '商品名称';
$_LANG['goods_sn'] = '货号';
$_LANG['shop_price'] = '价格';
$_LANG['is_on_sale'] = '上架';
$_LANG['goods_number'] = '库存';
$_LANG['lab_suppliers'] = '供货商';
$_LANG['copy'] = '复制';
$_LANG['item_list'] = '货品列表';
$_LANG['if_on_sale'] = '上架状态';
$_LANG['integral'] = '积分额度';
$_LANG['on_sale'] = '上架';
...
$_LANG['goods_sn_exists'] = '您输入的货号已存在，请更换！';
...
$_LANG['lab_is_free_shipping'] = '是否包邮：';
...
$_LANG['notice_user_price'] = '会员价格为-1时表示会员价格按会员等级折扣率计算。您也可以为每个等级指定一个固定价格';
...
$_LANG['goods_img_too_error'] = '商品外部图片必须是http或者https';
$_LANG['img_url_too_big'] = '商品相册中第%s个图片文件太大了（最大值：%s），无法上传！';
$_LANG['file_url_too_big'] = '附件中第%s个文件太大了（最大值：%s），无法上传！';

$_LANG['integral_market_price'] = '取整数';
$_LANG['upload_images'] = '上传图片';
$_LANG['spec_price'] = '属性价格';
$_LANG['drop_img_confirm'] = '您确定要删除该图片吗？';
$_LANG['drop_file_confirm'] = '您确定要删除该文件吗？';
...
$_LANG['group_price']         = '拼团价';
$_LANG['spike_price']         = '开启秒杀';
$_LANG['spike_goods_number']         = '商品数量';
$_LANG['spike_goods_amount']         = '商品金额';
$_LANG['spike_goods_num_des']         = '请输入秒杀商品的数量';
$_LANG['spike_goods_amo_des']         = '请输入秒杀商品的金额';
...
$_LANG['js_languages']['promote_not_lt'] = '促销开始日期不能晚于结束日期！';
$_LANG['js_languages']['promote_start_not_null'] = '促销开始时间不能为空！';
$_LANG['js_languages']['promote_end_not_null'] = '促销结束时间不能为空！';

$_LANG['js_languages']['drop_img_confirm'] = '您确定要删除该图片吗？';
$_LANG['js_languages']['batch_no_on_sale'] = '您确定要将选定的商品下架吗？';
$_LANG['js_languages']['batch_trash_confirm'] = '您确定要把选中的商品放入回收站吗？';
$_LANG['js_languages']['go_category_page'] = '本页数据将丢失，确定要去商品分类页添加分类吗？';
$_LANG['js_languages']['go_brand_page'] = '本页数据将丢失，确定要去商品品牌页添加品牌吗？';
